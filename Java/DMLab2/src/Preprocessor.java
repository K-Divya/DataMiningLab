...
public class Preprocessor {
    ...
    public void handleMissing (int col, String naIndicator, Boolean isNumeric){
    ...
    public static void main(String args[]){
        ...
        Preprocessor processor = new Preprocessor("input.csv");
        processor.handleMissing(1, "NA", true);//age
        processor.handleMissing(5, "NA", false);//month
